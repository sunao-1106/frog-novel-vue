<template>
    <div class="wrapper">
       <div style="margin: 150px auto;background-color: #fff;width: 500px;height: 400px;padding: 20px;border-radius: 10px">
           ...
           <el-form-item style="margin: 10px 0;">
               <el-button  style="text-align: right" type="primary" size="small" autocomplete="off" @click="login">确定</el-button>
                <el-button style="text-align: right" type="primary" size="small" autocomplete="off" @click="$router.push('/login')">登录</el-button>
           </el-form-item>
